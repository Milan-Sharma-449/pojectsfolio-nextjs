      ...
      <div className="grid grid-cols-2 gap-8 px-20 py-6 lg:py-8 md:grid-cols-4">
        <div>
            ...
            <ul className="text-gray-500 dark:text-gray-400 font-medium">
                <li className="mb-4">
                    <a href="https://milansharma.me" className=" hover:underline">About</a>
                </li>
                <li className="mb-4">
                    <a href="https://milansharma.me" className="hover:underline">Visit Us</a>
                </li>
                <li className="mb-4">
                    <a href="https://milansharma.me/contact/" className="hover:underline">Contact Us</a>
                </li>
                <li className="mb-4">
        ...
        <div>
            ...
            <ul className="text-gray-500 dark:text-gray-400 font-medium">
                <li className="mb-4">
                    <a href="https://www.facebook.com/milan.sharma.980315/" className="hover:underline">Facebook</a>
                </li>
                <li className="mb-4">
                    <a href="https://twitter.com/milansharma449" className="hover:underline">Twitter</a>
                </li>
                <li className="mb-4">
                    <a href="https://github.com/Milan-Sharma-449" className="hover:underline">GitHub</a>
                </li>
                <li className="mb-4">
                    <a href="https://milansharma.me/contact/" className="hover:underline">Contact Us</a>
                </li>
